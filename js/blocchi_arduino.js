// ============================================================
//  AVVIO SICURO DOPO IL CARICAMENTO DELLA PAGINA
// ============================================================
...
//  FUNZIONE PRINCIPALE
// ============================================================
function initBlocchiArduino() {

    // ============================================================
    //  IMPORT FIREBASE
    // ============================================================
    import("./firebase.js").then(({ db, ref, get, set, remove, child }) => {
